...
export const CheckoutCard = ({
  ...
  <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col h-[fit-content] sm:mx-[20%] sm:my-0 xl:m-0 lg:col-span-3 xl:col-span-2 ">
    ...
    <button className="bg-gray-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-base sm:text-lg shadow-md hover:bg-gray-700 transition ease-in-out duration-200 transform hover:scale-105 mt-4 w-full lg:w-auto">
      Proceed to Checkout
    </button>
  </div>
);
