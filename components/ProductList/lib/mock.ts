...
export const sneakers: Sneaker[] = [
  ...
  },
  {
    ...
    price: 55,
    description:
      "The Converse Chuck Taylor All Star is the original basketball shoe turned streetwear staple.",
    image: "/temp/converse.jpg",
  ...
  {
    id: 10,
    model: "Adidas Originals x Raf Simons Replicant Ozweego Core",
    brand: "Adidas",
    price: 330,
    description:
